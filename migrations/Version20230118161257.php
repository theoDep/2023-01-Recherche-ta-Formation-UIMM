...
final class Version20230118161257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, studies_level INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE formation_code (formation_id INT NOT NULL, code_id INT NOT NULL, INDEX IDX_20CAD5D85200282E (formation_id), INDEX IDX_20CAD5D827DAFE17 (code_id), PRIMARY KEY(formation_id, code_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE formation_job (formation_id INT NOT NULL, job_id INT NOT NULL, INDEX IDX_4C88858C5200282E (formation_id), INDEX IDX_4C88858CBE04EA9 (job_id), PRIMARY KEY(formation_id, job_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE formation_cost (formation_id INT NOT NULL, cost_id INT NOT NULL, INDEX IDX_4FF971BC5200282E (formation_id), INDEX IDX_4FF971BC1DBF857F (cost_id), PRIMARY KEY(formation_id, cost_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE formation_location (formation_id INT NOT NULL, location_id INT NOT NULL, INDEX IDX_990CDE3A5200282E (formation_id), INDEX IDX_990CDE3A64D218E (location_id), PRIMARY KEY(formation_id, location_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE formation_format (formation_id INT NOT NULL, format_id INT NOT NULL, INDEX IDX_FEA37CF25200282E (formation_id), INDEX IDX_FEA37CF2D629F605 (format_id), PRIMARY KEY(formation_id, format_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
